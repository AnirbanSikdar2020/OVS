	...
	<div class="container-fluid">
		<div class="container" style="border:2px solid black;">
					...
					<nav class="navbar navbar-light bg-light navbar-expand-md">
						...
						<div class="collapse navbar-collapse" id="myNavbar">
							<ul class="navbar-nav text-center" style="width:100%;">
								...
								<li class="nav-item"><a href="v_help.php" class="nav-link active">Help</a></li>
			...
			<div class="row pt-5 pb-sm-4"  style="background:#fff;">
				<div class="col">
				<h4 class="text-danger mb-4"><u>Help</u></h4>
					<div class="text-center">	
						<p>The Election Commission of India (ECI) is a permanent and independent body established by the Constitution of India directly to ensure free and fair elections in the country. Article 324 of the Constitution provides that the power of superintendence, direction, and control of elections to parliament, state legislatures, the office of the president of India, and the office of vice-president of India shall be vested in the election commission. Thus, the Election Commission is an all-India body in the sense that it is common to both the Central government and the state governments.<br />This website is operated by Election commision of India for performing online election process<br />In case of any problem kindly contact at anirbansikdar00@gmail.com or call tollfree at 1800 200 200</p>
					</div>
				</div>
			</div>
		</div>
