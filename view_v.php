	...
	<div class="container-fluid pb-0" >
		<div class="container" style="border:2px solid black;">
					...
					<nav class="navbar navbar-light bg-light navbar-expand-md">
						...
						<div class="collapse navbar-collapse" id="myNavbar">
							<ul class="navbar-nav text-center" style="width:100%;">
								...
								<li class="nav-item"><a href="" class="nav-link active">View</a>
									<ul class="sub-menu">
			...
			<div class="row pt-5 pb-sm-4"  style="background:#fff;">
				<div class="col">
				<h4 class="text-danger mb-4"><u>View Voter List</u></h4>
				<div class="text-center">	
					<?php
						include("connect.php");
						$sql = "SELECT * FROM user where validity='voter' and state='".$_SESSION["select_state"]."'  ";
						$result=mysqli_query($con,$sql);
						echo "<div id='table'><table style='border:2px solid black;width:100%;'>";
							echo "<tr>";
							...
							if(mysqli_num_rows($result)>0)
							{
								...
								{ 
									...
									echo "<tr>";
										echo '<td style="border:2px solid black;">'.$row["sl"].'</td>';
										echo '<td style="border:2px solid black;">'.$row["uname"].'</td>';
										echo '<td style="border:2px solid black;">'.$row["dob"].'</td>';
										echo '<td style="border:2px solid black;">'.$row["voter_id"].'</td>';
										echo '<td style="border:2px solid black;">'.$row["aadhar"].'</td>';
